<div x-data="{
    ...
    listenForEvent() {
        window.Echo.channel('orders')
            .listen('.orders', (e) => { this.addToast('Pesanan Baru', `${e.customer_name} Baru saja membeli
    ${e.product_qty} buah ${e.product}`); });
    },
...
}" x-init="listenForEvent()" class="fixed bottom-[10px] right-[10px] z-50 space-y-3">
    <template x-for="toast in toasts" :key="toast.id">
        <div x-show="true" x-transition
            ...
            <div class="flex p-4">
                <div class="shrink-0">
                    <svg class="size-5 text-teal-500 mt-1" xmlns="http://www.w3.org/2000/svg" width="24"
